          ...
          <ul className={styles.listContainer}>
            <li className={styles.listItem}>
              ...
              <p className={styles.bulletDescription}>
                ...
                integrity of your building, bridge, or other structure, and
                design a safe and efficient system that meets all applicable
                codes and standards.
              </p>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              ...
              <p className={styles.bulletDescription}>
                Our firm offers expert remedial works and dilapidation reports
                as part of our comprehensive building inspection services. Our
            ...
            <li className={styles.listItem}>
              ...
              <p className={styles.bulletDescription}>
                Our team can conduct investigations to identify and provide
                expert witness testimony in cases involving structural failures,
