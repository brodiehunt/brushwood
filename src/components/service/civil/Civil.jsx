    ...
    <>
      <div className={styles.pageContainer}>
        ...
        <p className={styles.paragraph}>
          ...
          practices are the backbone of economic growth. With a dynamic team of
          skilled civil engineers, we embark on projects that shape the future
          of communities, ensuring durability, efficiency, and environmental
          responsibility.
        </p>
        <p className={styles.paragraph}>
        ...
        <p className={styles.paragraph}>
          ...
          feasibility studies to detailed design and construction oversight, our
          team is dedicated to ensuring that every facet of the project aligns
          with the highest standards of safety, functionality, and
          sustainability.
        </p>
        <p className={styles.paragraph}>
        ...
        <p className={styles.paragraph}>
          ...
          methodologies, or implementing smart infrastructure solutions, we stay
          at the forefront of industry trends to deliver projects that stand the
          test of time.
        </p>
        <p className={styles.paragraph}>
