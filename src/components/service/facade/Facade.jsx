  ...
  return (
    <>
      <div className={styles.pageContainer}>
        ...
        <div className={styles.firstContent}>
          <div className={styles.gridParagraphs}>
            <p className={styles.paragraph}>
              ...
              technological advancement. Our team of dedicated facade engineers
              brings a wealth of experience and expertise to every project,
              ensuring that each facade is not only visually striking but also
              engineered to perform at the highest standards.
            </p>
            <p className={styles.paragraph}>
              What sets us apart is our commitment to pushing the boundaries of
              facade design. We leverage cutting-edge technologies and materials
              to create bespoke solutions that meet the unique challenges posed
              by each architectural vision. Our engineers collaborate closely
              with architects, builders, and developers to transform concepts
              into reality, ensuring that the facade not only enhances the
              building's aesthetics but also contributes to its overall
        ...
        <p className={styles.paragraph}>
          Whether you are embarking on a new construction project or seeking to
          revitalize an existing structure, our team is poised to deliver
          solutions that elevate the visual appeal and functionality of your
          building. Discover the difference that exceptional facade engineering
          can make. Partner with Brushwood Engineering Group and embark on a
          journey where form meets function, and architectural visions become
          reality. Your building's facade is more than an exterior - it's a
          testament to craftsmanship, creativity, and our unwavering commitment
          to excellence.
        </p>
